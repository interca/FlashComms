package com.im.flashcomms.common.common.utils.sensitiveWord;


import com.im.flashcomms.common.common.algorithm.ac.ACTrie;
import com.im.flashcomms.common.common.algorithm.ac.MatchResult;
...
public class ACFilter implements SensitiveWordFilter {
    ...
    public String filter(String text) {
        ...
        List<com.im.flashcomms.common.common.algorithm.ac.MatchResult> matchResults = ac_trie.matches(text);
